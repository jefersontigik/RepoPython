...
lblFrase = Label(frame, text = 'Informe a frase:', 
...
lblResultado = Label(frame, text = 'Resultado...', 
                     font = ('Bookman Old Style', 11))
lblResultado.place(x = 20, y = 70)

btnReverter = Button(frame, text = 'Iniciar', 
                     command = reverter, 
                     font = ('Bookman Old Style', 14))
btnReverter.place(x = 180, y = 100)

btnLimpar = Button(frame, text = 'Limpar', 
                   command = limpar,
                   font = ('Bookman Old Style', 14))
